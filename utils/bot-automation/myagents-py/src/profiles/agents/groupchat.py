...
class GroupChatManager(ConversableAgent):
    ...
    def __init__(
        ...
        client_sent_queue=None,
        client_receive_queue=None,
    ...
    def run_chat(
        ...
        if self.client_receive_queue:
            with queue_lock:
                print(
                    f"GroupChatManager: Adding message to client_receive_queue: message={message}")
    ...
    def send(
        ...
        # If the silent flag is not set and the message is not a reply from the speaker,
        # add the message to the client_receive_queue
        # if not silent and not request_reply and self.client_receive_queue:
        #     with queue_lock:
        #         print(f"Adding message to client_receive_queue: {message}")
        #         if isinstance(message, dict):
        #             content = message.get("content")
        #         else:
        #             content = message
        #         self.client_receive_queue.put(
        #             {"name": recipient.name, "content": content, "role": "user"})
